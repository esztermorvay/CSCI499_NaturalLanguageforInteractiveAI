...
def downstream_validation(word_vectors_fn, external_val_analogies, context_size, spill = False):
    fn = f"graphs/downstream_eval_contextSize{context_size}"
    if spill:
        fn += "_spillover"
    fn += ".txt"
    with open(fn, 'w') as file:
        ...
        file.write("Loading vectors from file '%s'...\n" % word_vectors_fn)
        wv = gensim.models.KeyedVectors.load_word2vec_format(
            word_vectors_fn, binary=word_vectors_fn[-4:] == ".bin"
        )
        print("... done loading vectors")
        file.write("... done loading vectors \n")
        print(
        ...
        for t in t_tested:
            ...
            file.write("\trelation\tN\texact\tMRR\tMR\n")
